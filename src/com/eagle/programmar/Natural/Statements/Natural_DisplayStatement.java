...
import com.eagle.programmar.Natural.Natural_Expression.Natural_FunctionCall;
import com.eagle.programmar.Natural.Natural_Expression.Natural_SystemVariable;
...
public class Natural_DisplayStatement extends TokenSequence
{
	...
	public static class Natural_DisplayElement extends TokenChooser
	{
		...
		public Natural_SystemVariable sysVar;
		public Natural_KeywordChoice option = new Natural_KeywordChoice("HORIZ", "UNDERLINED", "TRAILER");
		public Natural_FunctionCall fnCall;
		public Natural_DisplayParameter parameter;
	...
	{
		public Natural_DisplayParametersAD parameterAD;
		public Natural_DisplayParametersCD parameterCD;
